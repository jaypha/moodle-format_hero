...
/**
 * Renderer for outputting the hero course format.
 *
 * @package     format_hero
...
/**
 * Basic renderer for hero format.
 *
 * @package     format_hero
 * @copyright   2019 Matt Porritt <mattp@catalyst-au.net>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_hero_renderer extends format_section_renderer_base {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        // Since format_hero_renderer::section_edit_control_items() only displays the 'Highlight' control when editing mode is on
    ...
    protected function start_section_list() : string {
        return html_writer::start_tag('ul', array('class' => 'hero'));
    }
    ...
    public function print_course_summary($course): void {
        ...
        if (!empty($courseformatoptions['sectionheading1'])) {
            ...
            $templatecontext->sectiontext1 = format_text($courseformatoptions['sectiontext1_editor']['text'], FORMAT_HTML);
        }
        ...
        if (!empty($courseformatoptions['sectionheading2'])) {
            ...
            $templatecontext->sectiontext2 = format_text($courseformatoptions['sectiontext2_editor']['text'], FORMAT_HTML);
        }
        ...
        if (!empty($courseformatoptions['sectionheading3'])) {
            ...
            $templatecontext->sectiontext3 = format_text($courseformatoptions['sectiontext3_editor']['text'], FORMAT_HTML);
        }
        ...
        if (!empty($courseformatoptions['sectionheading4'])) {
            ...
            $templatecontext->sectiontext4 = format_text($courseformatoptions['sectiontext4_editor']['text'], FORMAT_HTML);
        }
        ...
        if (!empty($courseformatoptions['sectionheading5'])) {
            ...
            $templatecontext->sectiontext5 = format_text($courseformatoptions['sectiontext5_editor']['text'], FORMAT_HTML);
        }
        ...
        if (has_capability('moodle/course:update', context_course::instance($course->id))
            ...
            $messsage = get_string('nocompletion', 'format_hero', $url->raw_out());
        ...
        if (empty($courseformatoptions['reversedisplay'])) {
            echo $this->render_from_template('format_hero/course_summary', $templatecontext);
        } else {
            echo $this->render_from_template('format_hero/course_summary_reverse', $templatecontext);
        }
    }
    ...
    public function print_single_section_page($course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
        ...
        echo $this->render_from_template('format_hero/course_topic', $templatecontext);
    }
    ...
    protected function get_nav_links($course, $sections, $sectionno) {
        ...
        while ($back >= 0 and empty($links['previous'])) {
            if ($canviewhidden || $sections[$back]->uservisible) {
                ...
                $previouslink .= get_string('previous', 'format_hero') . ' ';
        ...
        while ($forward <= $numsections and empty($links['next'])) {
            if ($canviewhidden || $sections[$forward]->uservisible) {
                ...
                $nextlink = get_string('next', 'format_hero') . ' ';
